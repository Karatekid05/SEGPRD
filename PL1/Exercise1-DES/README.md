...
| `decrypt.py` | DES brute-force tool (Part 2a) |
| `des_analysis.py` | Key complexity, symbol domain, plot, 3DES demo (Part 2b–e) |
| `openssl_demo.sh` | OpenSSL DES encrypt/decrypt demo (Part 1) |
| `des_complexity_plot.png` | Generated by `des_analysis.py` (Part 2d) |
